...
class SQLiteHelperFull(val context: Context): SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    fun clearGradients() {
        val clearDB = "DELETE FROM " + TABLE_NAME
        this.readableDatabase.execSQL(clearDB)
    }
